...
A Raspberry Pi can be installed with KoC/Mwebaza packages and customizations using a pre-built image, or by following manual steps. The uncompressed image is about 8GB, so this should be done on with an SD Card that is at least 16GB:
